...
## Examplary use cases and security challenges {#sec3-3}
...
Tables {{fig31}} and {{fig32}} in Section {{sec13}} summarize how these threats apply to different parts of an IoT system at different phases in the device lifecycle.
...
In this section, we further detail some of them that will be used later to compose security profiles:
...
{{fig5}} depicts the main parties involved in the protocol: two smart objects denoted as 'Thing1' and 'Thing2', a  device controlling the IoT domain called 'GW', a router towards the IoT domain, the manufacturer server of 'Thing1' denoted as 'M1' and the server of the platform denoted as 'platform'.
...
Section {{sec8}} describes how manufacturers, system operators and end users benefit from PASC and PAVA when creating, making or using IoT systems.
...
The main contribution of this document is to describe and propose protocols to automate IoT security.
This is done in two steps. 
First, the PASC protocol allows to automatically configure devices and deploying security profiles -- sets of security configurations -- to the devices that join a given network and system.
Second, the PAVA protocol allows to automatically monitor the operation of the network and system in order to defeat any attack.
A key contribution of this document is the definition of exemplary security profiles that can be deploy to the devices.
...
# Summary of threats {#sec13}

We can classify threats presented in Section {{sec4}} according to two criteria: a) what is the target of the threat? and b) when does the threat take place?
...
# IANA Considerations {#sec14}

This document contains no request to IANA.

# Acknowledgments {#sec15}
